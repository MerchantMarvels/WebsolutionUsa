    ...
    <footer className="footer">
      <div className="footer-inner">
        ...
        <div data-aos="fade-up" className="footer-col">
          <h4>Quick Links</h4>
          <ul>
            <li><a href="/templates/restaurant/">Home</a></li>
            <li><a href="/templates/restaurant/#menu">Menu</a></li>
            {/* <li><a href="/templates/restaurant/#locations">Locations</a></li> */}
            <li><a href="/templates/restaurant/#about">About</a></li>
            <li><a href="/templates/restaurant/#connect">Contact</a></li>
          </ul>
        </div>
